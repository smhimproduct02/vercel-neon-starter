...
import { getDeviceRecords, deleteDeviceRecord, syncFromGoogleSheets } from '@/app/actions';
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    ...
                    <div className="flex gap-3">
                        <button
                            onClick={handleSync}
                            disabled={isSyncing}
                            className="px-4 py-2 text-sm font-medium bg-purple-600 hover:bg-purple-700 text-white rounded-xl transition-colors disabled:opacity-50 flex items-center gap-2"
                        >
